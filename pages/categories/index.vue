<template lang="html">
    <div class="ps-page">
        <header-dashboard title="Categories" description="Loot Box Category Listing" />
...
import FormProductCreateNew from "~/components/shared/forms/FormProductCreateNew";
